...
function init()
  ...
  craftingButton = modules.client_topmenu.addRightGameToggleButton('craftingButton', tr('Crafting'), '/game_crafting/images/crafting_button', show)
  ...
  if selectedCategory and selectedCraftId then
    ...
    if craft then
      for i = 1, #craft.materials do
        ...
        materialWidget:setImageSource("/game_crafting/images/craft_line" .. i .. "on")
        scheduleEvent(
          function()
            materialWidget:setImageSource("/game_crafting/images/craft_line" .. (i == 2 and 5 or i))
          end,
          850
        )
      end
